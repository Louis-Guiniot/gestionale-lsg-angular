...
export const createInvoice = createAction('[Invoice] creazione fattura', props<{custId:string,payCondition:string,docType:string,sale:string,idItemsString:string,qntItemsString: string, iva: string}>());
...
export const updateInvoice=createAction('[Invoice] update fattura', props<{idS: string, custId: string, payCondition: string, docType: string, sale: string, idItemsString: string, taxable: string, qntItemsString: string, saleImport: string, iva: string}>())
