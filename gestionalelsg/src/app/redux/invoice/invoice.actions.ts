...
export const createInvoice = createAction('[Invoice] creazione fattura', props<{custId:string,payCondition:string,docType:string,sale:string,articles:string,taxable:string}>());
