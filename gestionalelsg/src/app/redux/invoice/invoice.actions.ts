...
export const createInvoice = createAction('[Invoice] creazione fattura', props<{customerId:string, prodottiLista:string, date:string, sconto:string, imponibile:string, condizione:string, docType:string}>());
