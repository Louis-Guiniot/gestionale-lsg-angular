...
export const createPhi = createAction('[Phi] creazione phi', props<{idInvoice:string,idProduct: string,qtaProduct:string}>());
export const retrieveAllPhi = createAction('[Phi] phi');
export const initPhi = createAction('[Phi] init phi', props<{response: Response}>());
export const deletePhi=createAction('[Phi] delete phi', props<{idInvoice:string,idProduct: string,qtaProduct:string}>());
